...
const MacLogo = () => {
  ...
  return (
    <svg id="Слой_1" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"
         viewBox="0 0 150 190">
      <defs>
        <style>.cls-1fill-rule:evenodd;fill:url(#linear-gradient);}</style>
        <linearGradient id="linear-gradient" x1="75" y1="63.18" x2="75" y2="146.91" gradientUnits="userSpaceOnUse">
